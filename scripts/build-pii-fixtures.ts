...
const labelled: LabelledExample[] = [
  ...
  buildExample(
    ...
    [
      ...
      pii("private_person", "Alex Example"),
      " near the office at ",
      pii("private_address", "42 Kungsgatan Court"),
      " and we talked through the Robin situation. Need to follow up with ",
      pii("private_person", "Robin"),
      " next week.",
    ],
  ...
  buildExample(
    ...
    [
      ...
      ", email ",
      pii("private_email", "lars.oberg@example.invalid"),
      ".",
    ],
    { lang: "sv", category: "hr" },
  ),
  ...
  buildExample(
    ...
    [
      ...
      ": ",
      pii("private_person", "Taylor Example"),
      " on the ExampleCo report, ",
      pii("private_person", "Robin Sample"),
      " on hardware, ",
      pii("private_person", "Alex Example"),
      " blocked on a grant application.",
    ],
    { lang: "en", category: "journal" },
  ),
